...
const activeStyle =
  "hover:bg-back hover:text-white flex  rounded-md items-center gap-2 py-2 font-bold bg-gray";
const notActiceStyle =
  "hover:bg-back hover:text-white flex rounded-md items-center gap-2 py-2 cursor-pointer";
