...
const notActive =
  "w-[46px] h-[48px] flex justify-center items-center bg-white hover:bg-gray rounded-md";
const active =
  "w-[46px] h-[48px] flex justify-center items-center bg-secondary1 text-white hover:opacity-90 rounded-md";
